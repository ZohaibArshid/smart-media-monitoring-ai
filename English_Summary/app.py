...
#     return api_key
# @app.post("/English_Summary/")
# async def English_Summary_endpoint(
#     text: str,
...
#     import uvicorn
#     uvicorn.run(app, host="0.0.0.0", port=1007,reload=True)
    
# # run command in cmd 
# # uvicorn app:app --host 0.0.0.0 --port 1007 --reload
